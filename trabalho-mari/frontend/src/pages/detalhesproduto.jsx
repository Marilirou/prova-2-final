...
export default function DetalhesProduto() {
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: "20px", background: "#f8f8f8", padding: "20px", borderRadius: "8px" }}>
        {produto.imagem && (
          <img
            src={produto.imagem}
            alt="Produto"
            style={{ maxWidth: "200px", borderRadius: "8px", marginBottom: "20px" }}
          />
        )}
        ...
        <p><strong>Descrição complementar:</strong><br />{produto.descricao_complementar || "–"}</p>
      </div>
    </div>
  );
}
